...
export const getUserLoginDetails = (mobile) => (dispatch) => {
      ...
      return axios.get(`https://shoppers-in.onrender.com/userDetails?q=${mobile}`).then((res) => { console.log(res.data[0],"from get request in action"); dispatch(getUserLoginDataSuccess(res.data))} ).catch(
...
export const postNewUserLoginDetails = (data) => (dispatch) => {
      ...
      return axios.post(`https://shoppers-in.onrender.com/userDetails`,data).then((res) => 
...
export const updateUserAuthStatus = (id,isAuth) => {
      axios.patch(`https://shoppers-in.onrender.com/userDetails/${id}`,isAuth)
}